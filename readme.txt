...
== TODO ==
* ADD: Collapse answers if there is extrimely more answers (it will show on poll mouse hover, and there will be bottom array)
* ADD: "all voters" at the bottom of poll if poll is multiple.
* ADD: ability to sort answers in edit/add poll admin page
* ADD: votes count: choose how to show counts in multiple poll: as total votes for answers or total voters (now show votes).
* ADD: button to delete all logs of closed polls.
* ADD: possibiliti to delete single answer log.
* ADD: select how delete log: with votes of question or just delete selected logs.
